...
>
> ### ✅ 1-epoch 对照格已提交(job 16077163,floor 16077164)
>
> **单变量:epochs 3 → 1,四个臂一起改**。T = 176(原 528),所有 lr ×√3 保持实测位移不变
...
>
> **预先说清楚的一个 caveat**:保持位移不变意味着参数**走得还是一样远**,变的只是过数据的
> 遍数。如果 1-epoch 格仍然是同样的反相关,那么下一个杠杆就是位移本身(即**不**搬运 lr),
> 那是**另一个格**,不要和这个混为一谈。
>
