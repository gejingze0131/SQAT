...
>
> | 臂 | 等效 bit | 3 epoch | **1 epoch** | Δ | 3-ep 的 test/train |
> |---|---|---|---|---|---|
> | QLoRA fp16 上界 | 16 | 5.087 | **4.845** | −0.24 | 1.30× |
> | QEFT† | 2.75 | 6.683 | **6.024** | −0.66 | 1.90× |
> | QA-LoRA | 2.00 | 8.817 | **6.296** | **−2.52** | 3.93× |
> | SALT-Q | 2.00 | 10.154 | **7.002** | **−3.15** | 6.75× |
> | QLoRA→GPTQ floor | 2.00 | 10.273 | ⏳ 16077164 | | 1.10× |
>
...
>
> **3. QEFT 的比特预算优势几乎蒸发了。** 3 epoch 时它领先 QA-LoRA **2.13**,1 epoch 时只领先
...
> 遍数;结果是 gap 减半而非消失。下一个杠杆就是位移本身(即**不**搬运 lr),那是**另一个格**,
> 不要和这个混为一谈。
>
